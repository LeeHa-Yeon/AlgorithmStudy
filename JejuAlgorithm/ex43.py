...
print("-------------------------------------------",end="\n")
print("--------> 방법 7: 다른진수 형태에서 10진수로 변환")

b3 = int('0b1101',2)
o3 = int('0o15',8)
h3 = int('0xd',16)

print("2진수 -> 10진수 :",b3, end="\n")
print("8진수 -> 10진수:",o3, end="\n")
print("16진수 -> 10진수:",h3, end="\n")

print("-------------------------------------------",end="\n")
print("--------> 방법 8: 다른진수 형태에서 다른진로 변환")
...
print("2진수 -> 8진수 :",b_o, end="\n")
print("2진수 -> 16진수:",b_h, end="\n")
print("2진수 -> 10진수:",b_d, end="\n")
